            ...
            >
                <div className="max-w-7xl mx-auto h-24 px-6 relative flex items-center justify-center">
                    ...
                    <button
                        ...
                        className="absolute left-6 flex flex-col gap-1 group"
                        aria-label="Abrir menu"
                    >
                        <span className="w-8 h-1 bg-white rounded transition group-hover:bg-blue-400"></span>
                        <span className="w-8 h-1 bg-white rounded transition group-hover:bg-blue-400"></span>
                        <span className="w-8 h-1 bg-white rounded transition group-hover:bg-blue-400"></span>
                    </button>
            ...
            >
                ...
                <nav className="flex flex-col gap-3 p-6">
                    ...
                    <Link
                        href="/"
                        onClick={() => setMenuAberto(false)}
                        className="text-white px-4 py-3 rounded-xl hover:bg-blue-100 transition"
                    >
                        🏠 Início
                    </Link>
